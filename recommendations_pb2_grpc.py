...
class RecommendationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetRecommendations = channel.unary_unary(
                ...
                request_serializer=recommendations__pb2.AnalysisResult.SerializeToString,
...
def add_RecommendationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetRecommendations': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=recommendations__pb2.AnalysisResult.FromString,
                    response_serializer=recommendations__pb2.RecommendationResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'recommendations.RecommendationService', rpc_method_handlers)
...
class RecommendationService(object):
    ...
    def GetRecommendations(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/recommendations.RecommendationService/GetRecommendations',
            recommendations__pb2.AnalysisResult.SerializeToString,
